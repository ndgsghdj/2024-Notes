...
for i in range(numFish):
    ...
    fishweight.append(weight)
    fishlength.append(length)

print("Average weight of fish: {}".format(sum(fishweight)/len(fishweight)))
print("Average length of fish: {}".format(sum(fishlength)/len(fishlength)))
